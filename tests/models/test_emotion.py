import pandas as pd
import pytest
from models.emotion_model.emotion_analysis import EmotionAnalyzer
...
def test_get_top_emotion_structure(sample_df):
    analyzer = EmotionAnalyzer(sample_df, "quote")
